...
\begin{equation*}
   ...
   + \frac{\mu}{m_2}\, \vec r \times m_2\!\left(\frac{\mu}{m_2}\vec v\right)
\end{equation*}
\begin{equation*}
    = \left(\frac{\mu^2}{m_1} + \frac{\mu^2}{m_2}\right)\vec r \times \vec v = \mu^2 \left(\frac{1}{m_1} + \frac{1}{m_2}\right)\vec r \times \vec v
\end{equation*}
...
\begin{equation*}
    \frac{1}{2} m_1\!\left(\frac{\mu}{m_1}v\right)^2 
     + \frac{1}{2} m_2\!\left(\frac{\mu}{m_2}v\right)^2 
\end{equation*}
podemos escribir
\begin{equation*}
     \frac{1}{2}\left(\frac{\mu^2}{m_1} + \frac{\mu^2}{m_2}\right) v^2
\end{equation*}
y tenemos que
\begin{equation*}
    = \frac{1}{2}\mu^2\left(\frac{1}{m_1} + \frac{1}{m_2}\right)v^2
\end{equation*}
usando esta ultima expresión podemos llegar a nuestro resultado, 
\begin{formula}
    \begin{equation}
    T=\frac{1}{2}\mu v^2
\end{equation}
...
Para probar la conservación, tomamos la derivada total de la energía con respecto al tiempo, $\frac{dE}{dt}$. Si esta derivada es cero, la energía es constante. Aplicando la regla de la cadena y la regla del producto para derivadas temporales:
...
hemos demostrado que la energía mecánica se mantiene constante en el tiempo. 

\\

Una demostracion alternativa para este resultado se consigue usando la ecuaciónes de movimiento.
\\
 
Primero, recordamos las siguientes definiciones de posición 
\begin{equation*}
    \vec{r} = r\vec{e}_r
\end{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    y el sabemos que el módulo para el momento angular es $\mu r^2 \dot{\phi}=l$, tenemos una expresión de la forma 
    \begin{equation}
        E=\frac{1}{2}\mu 
...
luego se verifica que $\dot{r}=0$ y tenemos que $r=\text{cte}=r_0$
No es posible ninguna energía superior al mínimo, pues obtendríamos $\dot{r}$ que no son reales
...
\begin{equation*}
    \ddot{r} = \frac{\ell^2}{\mu^2 r^2} \frac{d}{d\phi} \left[ \frac{1}{r^2} \frac{dr}{d\phi} \right]
\end{equation*}
con el cambio de variable
\begin{equation*}
    \ddot{r} = \frac{\ell^2}{\mu^2 r^2} \frac{d}{d\phi} \left[ - \frac{du}{d\phi} \right] 
\end{equation*}
y ahora agrupamos de forma que
\begin{equation*}
...
\noindent Sustituyendo $\ddot{r}$ en la ecuación de movimiento ($\mu \ddot{r} = F_{r}$), obtenemos la ecuación diferencial de la trayectoria:
$$
\mu \left( -\frac{\ell^2}{\mu^2 r^2} \frac{d^2}{d\phi^2} \left( \frac{1}{r} \right) \right) = \frac{\ell^2}{\mu r^3} - \frac{K}{r^2}
$$
...
\noindent De donde resulta el semieje mayor $a$:
